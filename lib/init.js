...
function run(targetDir) {
  ...
  out('  ' + bold('Next steps'));
  out('    ' + amber('1') + '  ' + ui.padEnd('Review your changes', 22) + cyan('git status'));
  out('    ' + amber('2') + '  ' + ui.padEnd('Commit them', 22) + dim('teammates get teamlore on their next ') + cyan('git pull'));
  out('    ' + amber('3') + '  ' + ui.padEnd('Keep coding', 22) + dim('lore is recalled — and proposed — automatically'));
  out('');
